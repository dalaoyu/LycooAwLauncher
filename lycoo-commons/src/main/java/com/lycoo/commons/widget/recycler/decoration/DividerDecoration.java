...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        CustomRecyclerViewAdapter advancedLoadRecyclerViewAdapter;
        if (adapter instanceof CustomRecyclerViewAdapter) {
            advancedLoadRecyclerViewAdapter = (CustomRecyclerViewAdapter) adapter;
        } else {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (advancedLoadRecyclerViewAdapter.isRefreshHeader(position) || advancedLoadRecyclerViewAdapter. isHeader(position) || advancedLoadRecyclerViewAdapter.isFooter(position)) {

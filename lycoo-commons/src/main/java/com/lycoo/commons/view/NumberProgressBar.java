...
/**
 * a Number progressBar, used for loading or download data<br>
 * <p>
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mReachedBarColor = attributes.getColor(
                ResourceUtils.getIdByName(
                        context,
                        "styleable",
                        "NumberProgressBar_reachedBarColor"),
        ...
        mUnreachedBarColor = attributes.getColor(
                ResourceUtils.getIdByName(
                        context,
                        "styleable",
                        "NumberProgressBar_unReachedBarColor"),
        ...
        mReachedBarHeight = attributes.getDimension(
                ResourceUtils.getIdByName(
                        context,
                        "styleable",
                        "NumberProgressBar_reachedBarHeight"),
        ...
        mUnreachedBarHeight = attributes.getDimension(
                ResourceUtils.getIdByName(
                        context,
                        "styleable",
                        "NumberProgressBar_unReachedBarHeight"),
        ...
        int textVisible = attributes.getInt(
                ResourceUtils.getIdByName(
                        context,
                        "styleable",
                        "NumberProgressBar_textVisibility"),

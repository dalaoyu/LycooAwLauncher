...
public class CircleProgressBar extends ProgressBar {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //圆的半径
        mRadius = typedArray.getDimension(R.styleable.CircleProgressBar_circleRadius, dp2px(context, 17));
        typedArray.recycle();
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (mStatus == Status.LOADING) {
            ...
            switch (mStatus) {
                case WAITING:
                default:
                    drawableInt = R.drawable.common_ic_progressbar_waiting;
                    break;
                case PAUSE:
                    drawableInt = R.drawable.common_ic_progressbar_pause;
                    break;
                case FINISH:
                    drawableInt = R.drawable.common_ic_progressbar_finish;
                    break;
                case ERROR:
                    drawableInt = R.drawable.common_ic_progressbar_error;
                    break;
            }

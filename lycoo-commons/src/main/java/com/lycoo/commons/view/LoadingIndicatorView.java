...
public class LoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMinWidth = array.getDimensionPixelSize(
                R.styleable.LoadingIndicatorView_minWidth,
                getResources().getDimensionPixelSize(R.dimen.def_loading_indicator_min_width));
        mMaxWidth = array.getDimensionPixelSize(
                R.styleable.LoadingIndicatorView_maxWidth,
                getResources().getDimensionPixelSize(R.dimen.def_loading_indicator_max_width));
        mMinHeight = array.getDimensionPixelSize(
                R.styleable.LoadingIndicatorView_minHeight,
                getResources().getDimensionPixelSize(R.dimen.def_loading_indicator_min_height));
        mMaxHeight = array.getDimensionPixelSize(
                R.styleable.LoadingIndicatorView_maxHeight,
                getResources().getDimensionPixelSize(R.dimen.def_loading_indicator_max_height));
        mIndicatorColor = array.getColor(
                R.styleable.LoadingIndicatorView_indicatorColor,
                getResources().getColor(R.color.win_light_cool_blue));

        String indicatorName = array.getString(R.styleable.LoadingIndicatorView_indicatorName);
